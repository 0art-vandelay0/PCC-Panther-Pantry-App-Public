# Run this file to launch the main GUI
...
from UI.SendNotificationUI.SendNotificationUI import SendNotificationUI
from UI.TemplateCreationUI.TemplateCreationUI import TemplateCreationUI
from UI.ReviewNotificationLogUI.ReviewNotificationLogUI import ReviewNotificationLogUI
...
class TabbedUI:
    def __init__(self, toplevel):
        ...
        notification_app = SendNotificationUI(self.__mainwindow)
        self.__main_notebook.add(notification_app.get_top_frame(),
                                 text="Send a Notification"
                                 )

        # Add additional tabs here
        templateCreation_app = TemplateCreationUI(self.__mainwindow)
        self.__main_notebook.add(templateCreation_app.get_top_frame(),
                                 text="Create a Template"
                                 )
        reviewNotification_app = ReviewNotificationLogUI(self.__mainwindow)
        self.__main_notebook.add(reviewNotification_app.get_top_frame(),
